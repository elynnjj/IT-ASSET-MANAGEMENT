...
<head>
    ...
    <title>ExactAsset - Change Password</title>
                    ...
                    <form method="POST" action="{{ route('password.change.update') }}">
                        ...
                        <div class="mb-4">
                            <div class="input-with-icon">
                                ...
                                >
                                <span class="password-toggle text-gray-500 dark:text-gray-400" onclick="togglePassword('current_password')">
                                    <svg id="eye-icon-current_password" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
