				...
				<div class="p-6 text-gray-900 dark:text-gray-100">
					...
					<div class="mb-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
						...
						@if($hod)
							<div class="grid grid-cols-2 gap-4">
							<div class="border border-gray-200 dark:border-gray-600 rounded-md p-3 bg-white dark:bg-gray-800">
									<label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{{ __('Head of Department (HOD)') }}</label>
								<p class="text-sm text-gray-900 dark:text-gray-100 font-medium">{{ $hod->fullName }}</p>
								</div>
								<div class="border border-gray-200 dark:border-gray-600 rounded-md p-3 bg-white dark:bg-gray-800">
									<label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{{ __('Department') }}</label>
									<p class="text-sm text-gray-900 dark:text-gray-100 font-medium">{{ $hod->department }} Department</p>
								</div>
							</div>
						@else
					...
					<div class="mb-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
						...
						<form action="{{ route('employee.it-requests.store') }}" method="POST" @if(!$assignedAsset) onsubmit="return false;" @endif>
							@csrf
